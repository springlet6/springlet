...
public class TableField {
    ...
    public com.baomidou.mybatisplus.generator.config.po.TableField setConvert(boolean convert) {
        this.convert = convert;
        return this;
    }

    protected com.baomidou.mybatisplus.generator.config.po.TableField setConvert(StrategyConfig strategyConfig) {
    ...
    public com.baomidou.mybatisplus.generator.config.po.TableField setPropertyName(StrategyConfig strategyConfig, String propertyName) {
